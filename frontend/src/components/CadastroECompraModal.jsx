...
function CadastroECompraModal({ onFechar, onCadastrar }) {
    ...
    return (
        <div style={{
            ...
            alignItems: "center",
            zIndex: 1000,
            backdropFilter: "blur(2px)" // Um toque moderno de desfoque
        }}>
            <div style={{
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
                    ...
                    <div style={{ display: "flex", gap: "10px" }}>
                        <div style={{ flex: 1 }}>
                            ...
                            <input type="number" step="any" name="quantidade" onChange={handleChange} value={form.quantidade} style={inputStyle} placeholder="0.00" required />
                        </div>
                        <div style={{ flex: 1 }}>
                            <label style={{ fontWeight: "bold" }}>Preço Total (R$)</label>
                            <input name="precoTotal" type="number" step="any" onChange={handleChange} value={form.precoTotal} style={inputStyle} placeholder="0.00" />
                        </div>
                    </div>
...
export default CadastroECompraModal;