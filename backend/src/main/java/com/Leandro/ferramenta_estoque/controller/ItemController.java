...
public class ItemController {
    ...
    public ItemController(ItemService itemService, MovimentacaoService movimentacaoService) {
    ...
    @PostMapping("/cadastro-compra")
    public ResponseEntity<CadastroECompraResponseDTO> cadastroECompra(
            @Valid @RequestBody CadastroECompraRequestDTO requestDTO) {
        CadastroECompraResponseDTO itemCadastradoEComprado = movimentacaoService.cadastroECompra(requestDTO);
        return ResponseEntity.status(201).body(itemCadastradoEComprado);
    }
